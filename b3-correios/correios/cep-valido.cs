...
namespace correios
{
    ...
    public class CepValido
    {
        ...
        public void TheCepValidoTest()
        {
            ...
            Assert.AreEqual("Rua Quinze de Novembro - lado ímpar", driver.FindElement(By.XPath("//table[@id='resultado-DNEC']/tbody/tr/td")).Text);
        }
