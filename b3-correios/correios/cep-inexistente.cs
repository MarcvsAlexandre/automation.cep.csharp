...
namespace correios
{
    ...
    public class CepInexistente
    {
        ...
        [Test]
        public void TheCepInexistenteTest()
        {
            ...
            try
            {
                Assert.AreEqual("Dados não encontrado", driver.FindElement(By.XPath("//div[@id='mensagem-resultado-alerta']/h6")).Text);
            }
