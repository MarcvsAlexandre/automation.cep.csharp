...
namespace correios
{
    ...
    public class CepCodigo
    {
        ...
        public void TheCepCodigoTest()
        {
            ...
            driver.FindElement(By.Id("endereco")).SendKeys("SS987654321BR");
            driver.FindElement(By.Id("btn_pesquisar")).Click();
            try
            {
                Assert.AreEqual("Dados não encontrado", driver.FindElement(By.Id("mensagem-resultado-alerta")).Text);
            }
